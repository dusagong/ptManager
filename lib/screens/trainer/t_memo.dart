...
class _T_MemoState extends State<T_Memo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("메모",style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,color: Colors.white),),
          leading: IconButton(
            onPressed: (){Get.back();},
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      setState(() {
                                        ...
                                        selectedMemoIndex = -1;
                                        traineeDocumentRef = FirebaseFirestore.instance.collection("trainee").doc(documentName);
                                      });
                                    },
                                    child: Container(
                                      child: Column(
